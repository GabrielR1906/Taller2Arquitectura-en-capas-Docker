...
class EventoParticipante(models.Model):
    ...
    class Meta:
        verbose_name = "Inscripción Evento"
        verbose_name_plural = "Inscripciones Eventos"
...
# --- MODELO AGREGADO PARA LA ACTIVIDAD ---

class Inscripcion(models.Model):
    """Modelo para gestionar las inscripciones siguiendo el requerimiento"""
    evento = models.ForeignKey(Evento, on_delete=models.CASCADE, verbose_name="Evento")
    participante = models.ForeignKey(Participante, on_delete=models.CASCADE, verbose_name="Participante")
    fecha_inscripcion = models.DateField(auto_now_add=True, verbose_name="Fecha de Inscripción")
    estado = models.CharField(max_length=20, default='CONFIRMADA', verbose_name="Estado")
    ...
    def __str__(self):
        return f"{self.participante.nombre} - {self.evento.nombre}"